...
#     d_train.drop(['SNP44'],axis=1,inplace=True)
#     d_train.drop(['SNP52'],axis=1,inplace=True)
...
# f1_score train : 0.6794721393925802
# Accuracy : 0.7
# AUC Score : 0.760870
# f1_score test : 0.69562
...
#     d_train.info()
    if num==1:
        ...
        d_train = sfm.transform(d_train)
        
        train_x = d_train#.as_matrix()
#         from sklearn.datasets import load_iris
#         from sklearn.feature_selection import SelectKBest
#         from sklearn.feature_selection import chi2
#         train_x = SelectKBest(chi2, k=40).fit_transform(train_x, train_y)
...
gdbt=GradientBoostingClassifier(
                ...
                n_estimators=1100, # 迭代训练次数，回归树个数（弱学习器）
