...
#     d_train.drop(['性别'],axis=1,inplace=True)
...
#         def standard(d_train):
#             for columns in d_train.columns:
#                 columns_data = StandardScaler().fit_transform(d_train[columns])
#                 d_train[columns]=StandardScaler().fit_transform(d_train[columns].reshape(-1,1), columns_data)
#         standard(d_train)
         
        train_x = d_train.as_matrix()
        
# Accuracy : 0.73
# AUC Score (Train): 0.794715
# f1_score : 0.72643
