...
def make_feat(train,test):
    ...
    test_feat.info()
    test_feat.drop(['乙肝表面抗原'],axis=1,inplace=True)
    test_feat.drop(['乙肝表面抗体'],axis=1,inplace=True)
    test_feat.drop(['乙肝e抗原'],axis=1,inplace=True)
    test_feat.drop(['乙肝e抗体'],axis=1,inplace=True)
    test_feat.drop(['乙肝核心抗体'],axis=1,inplace=True)
    train_feat.drop(['乙肝表面抗原'],axis=1,inplace=True)
    train_feat.drop(['乙肝表面抗体'],axis=1,inplace=True)
    train_feat.drop(['乙肝e抗原'],axis=1,inplace=True)
    train_feat.drop(['乙肝e抗体'],axis=1,inplace=True)
    train_feat.drop(['乙肝核心抗体'],axis=1,inplace=True)
    test_feat.info()
