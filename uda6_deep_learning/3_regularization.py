...
# Problem 2
# ---------
# 让我们展示一个关于过拟合的极端例子，将训练数据限制的几个（少量）批次中，会发生什么
...
# 流失函数应该在训练时引入，不应该在评估时，否则你的评估结果也是随机的
...
# TensorFlow提供nn.dropout()，但是你需要保证只要训练期间插入
...
# Problem 4
# ---------
# 你可以使用一个多层神经网络模型试着获取一个最好的性能，使用深度神经网络学习的最好测试准确率是97.1%
